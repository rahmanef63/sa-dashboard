import { MenuItem, MenuItemWithChildren, NavMainData } from 'shared/types/navigation-types'

// Convert MenuItemWithChildren to MenuItem
export const convertToMenuItem = (item: MenuItemWithChildren): MenuItem => {
...
export const saveMenuItems = (items: MenuItemWithChildren[]) => {
